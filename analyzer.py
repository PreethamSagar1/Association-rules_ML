...
# Apriori Algorithm
def simple_apriori(df, min_support=0.1, min_confidence=0.5, max_rules=90):
            ...
            for i in range(1, len(item_set)):
                for antecedent in combinations(item_set, i):
                    ...
                    if confidence >= min_confidence:
                        ...
                        # Stop if the number of rules exceeds the maximum
...
def main():
    ...
    rules = simple_apriori(df_encoded, min_support=0.1, min_confidence=0.5, max_rules=90)
    ...
    print("Final K-Means clustering visuals saved.")
